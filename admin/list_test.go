...
// TestPaginationLinksRendering covers paginationLinks' rendering behavior
// across page-count scenarios: showing every page when there are few,
// truncating with an ellipsis when there are many, and producing no links
// at all for a single (or zero) page document.
func TestPaginationLinksRendering(t *testing.T) {
	t.Run("shows every page and marks the current one when there are few pages", func(t *testing.T) {
	...
	t.Run("truncates with an ellipsis and marks the current page for many pages", func(t *testing.T) {
	...
	t.Run("produces no links for a single page or zero pages", func(t *testing.T) {
